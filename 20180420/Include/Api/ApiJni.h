...
public:
	...
	static bool			CallJniReturnBool(const std::string& sPacketName, const std::string& sFuncName, const std::string& sArg1, const std::string& sArg2, const std::string& sArg3, const std::string& sArg4, const std::string& sArg5, const std::string& sArg6, const std::string& sArg7);
	static bool			CallJniReturnBool(const std::string& sPacketName, const std::string& sFuncName, const std::string& sArg1, const std::string& sArg2, const std::string& sArg3, const std::string& sArg4, const std::string& sArg5, const std::string& sArg6, const std::string& sArg7, const std::string& sArg8);
	static bool			CallJniReturnBool(const std::string& sPacketName, const std::string& sFuncName, const std::string& sArg1, const std::string& sArg2, const std::string& sArg3, const std::string& sArg4, const std::string& sArg5, const std::string& sArg6, const std::string& sArg7, const std::string& sArg8, const std::string& sArg9);
