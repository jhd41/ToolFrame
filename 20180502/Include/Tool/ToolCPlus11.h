...
namespace ToolFrame
{
	...
	typename std::function<R(A1, A2, A3, A4, A5, A6)> Bind(R(T::*f)(A1, A2, A3, A4, A5, A6), T* pClass);
	...
	template<typename R, typename T, typename A1, typename A2, typename A3, typename A4, typename A5, typename A6>
	typename std::function<R(A1, A2, A3, A4, A5, A6)> Bind(R(T::*f)(A1, A2, A3, A4, A5, A6)const, const T* pClass);
};
...
template<typename R, typename T, typename A1, typename A2, typename A3, typename A4, typename A5, typename A6>
typename std::function<R(A1, A2, A3, A4, A5, A6)> ToolFrame::Bind(R(T::*f)(A1, A2, A3, A4, A5, A6), T* pClass)
{
	return std::bind(f, pClass, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4, std::placeholders::_5, std::placeholders::_6);
}
...
template<typename R, typename T, typename A1, typename A2, typename A3, typename A4, typename A5, typename A6>
typename std::function<R(A1, A2, A3, A4, A5, A6)> ToolFrame::Bind(R(T::*f)(A1, A2, A3, A4, A5, A6)const, const T* pClass)
{
	return std::bind(f, pClass, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4, std::placeholders::_5, std::placeholders::_6);
}
