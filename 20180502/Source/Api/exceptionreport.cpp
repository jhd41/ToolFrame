...
NS_TOOL_FRAME_BEGIN
bool InitExceptionReport(){return true;}//仅仅绕过编译器完全链接的执行代码
NS_TOOL_FRAME_END
	...
	PEXCEPTION_POINTERS pExceptionInfo )
{
	...
	return EXCEPTION_EXECUTE_HANDLER;//SongJ
...
void MExceptionReport::GenerateExceptionReport(PEXCEPTION_POINTERS pExceptionInfo )
{
	...
	_tprintf(_T("ShutDown Time: %s \r\n"), ToolFrame::GetNowTimeString().c_str());
