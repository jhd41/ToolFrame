...
size_t MMySql::GetQueryCount() const
{
	size_t uCount = 0;
	CLockRead lock(_vRequest.GetMutex());
...
size_t MMySql::ClearProcessCount() 
{
	return _uProcessCount.ClearCounter();
}

size_t MMySql::GetQueryAvgTime() const
{
