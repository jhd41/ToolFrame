...
bool CAvgCounter::GetAvg( uint64* uTotal, uint64* uTimes /*= nullptr*/,uint64* uValueMax /*= nullptr */,uint64* uAvg /*= nullptr*/, uint64* uMarkTotal /*= nullptr*/,uint* uMarkTimes /*= nullptr*/,uint64* uMarkMax /*= nullptr */,uint64* uMarkAvg /*= nullptr*/ )
{
...
bool CAvgCounter::Clear( uint64* uTotal, uint64* uTimes,uint64* uValueMax ,uint64* uAvg, uint64* uMarkTotal,uint* uMarkTimes,uint64* uMarkMax ,uint64* uMarkAvg )
{
	CLockWrite lock(_mutex);
