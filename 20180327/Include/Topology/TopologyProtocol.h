...
SERIALIZE_CLASS(XLogicUpdate,		t.eState & t.uTimeReport & t.uTimeRunOnce & t.uTimeRunOnceMax & t.uCacheVaild & t.uCacheTotal & t.uProcesserCount & t.uQueueProcess & t.uCpuUseTime & t.uCpuUsage & t.uMemoryUsed & t.uThreads & t.nSessionNum & t.nPacketProcess & t.nLogicProcess & t.nNetProcess & t.nLogicCmd & t.nNetCmd & t.uSendBytes & t.uRecvBytes & t.uFreeTime & t.uTimeSave & t.uTimeCleanUp & t.uSystemCleanUp & t.uProcessMax & t.uProcessAvg & t.uTimeSendMax & t.uTimeSendAvg & t.uTimeSendingMax & t.uTimeSendingAvg);

SERIALIZE_CLASS(XServerLogic,		t.uServerID & t.eSrvType &t.uTimeStartUp & t.uReconnect & t.xUpdate);
	...
	:public IMsgStream
{
	...
	MSG_CONSTRUCT_SERIALIZE(MsgLogicRegist,MSG_LOGIC_REGIST,uServerID & eSrvType & xUpdate);
};
